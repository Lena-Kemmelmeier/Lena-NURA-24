            ...
            for t = 1:nTrialsTotal % start trial loop
              ...
              if trialType == 1 % this is a recall trial
                  ...
                  % each color must be at least 30 degrees apart from one another (don't want colors to look exactly the same!)
                    ...
                    diffColorInDegrees = first_num - 45; % subtracting vs. adding 180 makes no difference
                  ...
                  elseif itemToTest_mix(t) == 3
                   ...
                   intermix_colorsInDegrees{t} = random_numbers;
                   intermix_mismatchProbeDegrees{t} = diffColorInDegrees;
              ...
              if trialType == 1 % probe this trial with recall
                  ...
                  intermix_data = recogProbe(intermix_data, prefs, trialType, t, window, intermix_colorsInDegrees, intermix_mismatchProbeDegrees, colorsToDisplay, itemToTest_mix, rects, mouseCondition, recogCtr, data_name);
